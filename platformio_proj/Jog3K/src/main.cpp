...
//#define DLED
  ...
  const int DLEDcount = 20;              //How Many DLED LED's are you going to connect?
  const int DLEDPin = 21;                  //Where is DI connected to?
  const int DLEDBrightness = 50;         //Brightness of the LED's 0-100%
